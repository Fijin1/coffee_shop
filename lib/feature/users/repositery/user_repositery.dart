...
import '../screen/create_page.dart';
...
class Authrepository {
  ...
  signInWithGoogle(context) async {
    ...
    if(data.docs.isEmpty){
      ...
      UserModel userModel = UserModel(name: userName, email: userEmail!, password: '', image: userImg, id: user.uid,  status: false,);
      ...
      currentUserModel=UserModel(name: userName, email: userEmail!, password: "", image: userImg,  id:userId!, status: false, );
  ...
  newUserDetails(context,name, email, password,image,id, status,) async {
    ...
    UserModel userModel = UserModel(name: name, email: email, password: password, image: image, id: id,  status: false,  );
